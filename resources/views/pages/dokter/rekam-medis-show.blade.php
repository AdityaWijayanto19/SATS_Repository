...
@section('content')
    <main class="flex-1 overflow-y-auto p-6 bg-[rgba(230,238,236,0.5)] min-h-screen">
        <div class="flex items-center gap-3 mb-6">
            <a href="{{ route('dokter.rekam-medis') }}" class="text-[rgb(0,62,48)] hover:text-[rgb(0,80,60)] transition">
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                </svg>
            </a>
            <h1 class="text-3xl font-bold text-[rgb(0,62,48)]">Detail Rekam Medis</h1>
        </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <p class="font-semibold">{{ $session->creator?->name ?? '-' }}</p>
                        </div>
                        <div>
                            <p class="text-gray-500">Dokter yang Bertugas</p>
                            <p class="font-semibold">{{ $session->dokter?->name ?? '-' }}</p>
                        </div>
                        <div>
